...
public:
    ...
    // создает позицию и поворот в локальной системе координат, которая относится к этому объекту
    // трансформейшнал в пределах родительской для нее глобальной системы координат
